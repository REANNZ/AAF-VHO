...
<html>
  <head>
    ...
    <asset:javascript src="modernizr, bootstrap, bootstrap-responsive-css, bootstrap-notify, bootstrap-datepicker, bootbox, less, validate, datatables, formrestrict, app"/>
    <g:layoutHead />
  </head>
