    <div class="alert alert-info">
      <p>You must comply with the Federation Rules when managing accounts in the Tuakiri Virtual Home. This means:</p>
      <ul>
        <li>Generic accounts cannot be created for training or testing purposes;</li>
