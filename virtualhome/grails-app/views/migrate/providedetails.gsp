    ...
    <g:form useToken="true" action="validate" class="form-horizontal myaccount form-validating" name="accountform">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          ...
          <div class="span4">
            <span class="help-block">Please provide the password you're currently using with the Tuakiri Virtual Home so we can validate your previous account details.</span>
          </div>
        </div>
      </div>
